...
class LoadFactOperator(BaseOperator):
    ...
    def execute(self, context):
        self.log.info('LoadFactOperator in proccess')
        ...
        fact_table_sql = f"INSERT INTO {self.table} ({column_list})"
        fact_table_sql+=self.sql

        self.log.info(fact_table_sql)
        redshift.run(fact_table_sql)
